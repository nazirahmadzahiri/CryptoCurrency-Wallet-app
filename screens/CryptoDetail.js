      ...
      return(
       ...
       >
           ...
           <View>
               ...
               <Text style={{color: selectedCurrency?.type == "I" ? 
               COLORS.green : COLORS.red, ...FONTS.body3}}>{selectedCurrency?.changes} </Text>
           </View>
           </View>
       {/* Chart */}
       <Animated.ScrollView
       ...
       chartOptions.map((option) => {
           return (
               <TextButton 
                   ...
                   customLabelStyle={{
                       color: selectedOption.id == option.id ? COLORS.white :
                ...
                >
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center'}} >
                        <View style={{ marginRight: SIZES.base}} >
                            ...
                            <Text style={{ ...FONTS.body4, textAlign: 'right', color: COLORS.gray}}>{selectedCurrency?.wallet.crypto} {selectedCurrency?.code} </Text>
                        </View>
                        <Image 
